...
class S3DWithInternalOutput(nn.Module):
    def __init__(self, num_class):
        super(S3DWithInternalOutput, self).__init__()
    ...
    def forward(self, x, dummy=None):
        ...
        for i, layer in enumerate(self.base):
            x = layer(x)
            if i in [10, 12, 15]:
                # These indices are assuming 'Mixed_4d', 'Mixed_4f', 'Mixed_5c' are at these positions.
                outputs.append(x)
        ...
        outputs.append(None)  # place holder
